...
<div style="width: 100%;height: 50px;margin-top: 10px">
    <?php if ($pstate == 1) { ?>
        <div class="btn" style="width: 80%;background-color: #CCCCCC;margin-left: 10%;color: #999999">
            已经兑换过奖品了
        </div>
    <?php } else { ?>
...
<div class="weui_dialog_confirm" id="priceTip" style="display: none">
    ...
    <div class="weui_dialog">
        <div class="weui_dialog_hd"><strong class="weui_dialog_title">请工作人员输入兑奖密码</strong></div>
        <div class="weui_dialog_bd">
            <input type="tel" class="weui_input" style="margin-top: 10px" id="pwd">
        </div>
        <div class="weui_dialog_ft">
            <a href="#" class="weui_btn_dialog primary" id="cancal">取消</a>
...
<script>
    ...
    $("#confirm").tap(function () {
        var pwd=$("#pwd").val();
        $.ajax({
            url: "changeState.php?openid=<?php echo $openid;?>&pwd="+pwd,
            success: function (data) {
                if (data == 0) {
                    window.location.href = "RankPrice.php";
                } else {
                    alert("密码不对");
                }
            }
